    ...
    return (
        <section className="pair-info">
            <div className="p-3 btc-change d-flex align-items-center row ">
                ...
                <div className="col col-12  col-sm-6 col-md-3 col-lg-2">
                    <h3 className="text-secondary ">Last price</h3>,
                ...
                <div className="col col-12 col-sm-6 col-md-3 col-lg-2">
                    ...
                    ,
                    <div className="last-price d-flex flex-wrap">
                        <h3 className="fs-3 fw-bold text-dark me-2">0.60069</h3>
                    </div>
                </div>
                <div className="col col-12 col-sm-6 col-md-3 col-lg-2">
                    <h3 className="text-secondary ">
                    ...
                    ,
                    <div className="last-price d-flex flex-wrap">
                        <h3 className="fs-3 fw-bold text-dark me-2">0.056864</h3>
                    </div>
                </div>
                <div className="col col-12 col-sm-6 col-md-3 col-lg-2 ">
                    <h3 className="text-secondary">
                    ...
                    ,
                    <div className="last-price d-flex flex-wrap">
                        <h3 className="fs-3 fw-bold text-dark me-2">8,532.12 BTC</h3>
                    </div>
                </div>
            </div>
        </section>
